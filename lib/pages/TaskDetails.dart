...
class _TaskDetailsState extends State<TaskDetails> {
  ...
  void initState() {
    ...
    _dataController.text = _dateFormat.format(widget.taskModel.date);
            ...
            Form(
                ...
                child: Column(
                  children: [
                    ...
                    // update task button inside container  >>>>
                    Container(
                      height: 60.0,
                        ...
                        onPressed: () {
                          setState(() {
                            if (formKey.currentState.validate()) {
                              ...
                              TasksDbBuiler.getInstance().updataTask(taskModel);
                    ...
                    // delete task button inside container  >>>>
                    Container(
                      height: 60.0,
                      width: double.infinity,
                      decoration: BoxDecoration(
                      ...
                      child: FlatButton(
                        ...
                        onPressed: () {
                          setState(() {
                            if (formKey.currentState.validate()) {
                              // your code is here >>>
                              TasksDbBuiler.getInstance().deleteTask(widget.taskModel.id);
                              Navigator.of(context).pop(context);
                            }
                          });
                        },
